...
#    Updated: 2025/11/15 15:03:18 by joesanto         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PARSERS = $(addprefix parsers/, parse_fdf_file.c parse_voxel_file.c parse_picture.c)

DRAW = $(addprefix draw/, bresenham_drawline.c xiaolinwu_drawline.c liangbarsky_clipping.c)

MOTIONS = $(addprefix motions/, rotate.c player_motions.c)
...
LINKING = -lm
INCLUDES= $(addprefix -I, $(dir $(LIBS)) $(HEADERS_DIR))
