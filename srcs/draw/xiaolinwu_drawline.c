...
/*   Updated: 2025/11/18 19:33:22 by joesanto         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static inline
void	xiaolinwu_drawline_horizontal(t_img *img, t_pos p0, t_pos p1,
			unsigned int color)
{
...
static inline
void	xiaolinwu_drawline_vertical(t_img *img, t_pos p0, t_pos p1,
			unsigned int color)
{
